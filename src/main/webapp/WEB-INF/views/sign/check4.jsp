...
function searchname(num, name) {
	opener.document.getElementById('sign_receiver4').value = num;
	opener.document.getElementById('sign_nreceiver4').value = name;
	this.close();
}
</script>
</head>
...
<form action="check4" method="post" onSubmit="return formCheck();">
