    ...
    <div id="container">
        ...
        <div id="content">
         <ul class="nav nav-tabs" style="margin: 10px;">
           ...
           <li class="nav-item">
             <a class="nav-link active" aria-current="page"  href='<c:url value="../sign/swrite"/>'>결제 작성</a>
           </li>
         </ul>
        	<div id="sign">
        	<h2 style="margin: 15px 0px 30px 0px;  font-size: 40px;" >결제 서류</h2>
        		<form id="swrite" action="swrite"  method="post" onsubmit="return formCheck();" enctype="multipart/form-data"	style="margin-left: 260px;">
	        		<div class="input-group" style="border: 1px solid rgb(238, 238, 238); width: 90%; margin: 0px auto 10px auto;">
					  	<span class="input-group-text" id="basic-addon1" style="width: 100px; text-align: center; font-weight: bold; height : 40px;">제목</span>
					  	<input type="text" name="sign_title" id="sign_title" style="width:500px; height : 40px;">
					</div>
					<div class="input-group" style="border: 1px solid rgb(238, 238, 238); width: 90%;  margin: 0px auto 10px auto;">
					...
					<div class="input-group" style="border: 1px solid rgb(238, 238, 238); width: 90%;  margin: 0px auto 10px auto;">
						 ...
						 <input type="text" name="sign_nsender" id="sign_nsender" size="30" style="height : 40px; " value="${member.employee_name}" readonly="readonly">						 
					</div>
					<div class="input-group" style="border: 1px solid rgb(238, 238, 238); width: 90%;  margin: 0px auto 10px auto;">
						 <span class="input-group-text" style="width: 100px; font-weight: bold; height : 40px;">부서</span>
						 <input type="text" name="sign_dep" id="sign_dep" size="30" style="height : 40px; " value="${member.employee_dep}" readonly="readonly">						 
					</div>
					<div class="input-group" style="border: 1px solid rgb(238, 238, 238); width: 90%; margin: 0px auto 10px auto;">
						 <span class="input-group-text" style="width: 100px; font-weight: bold; height : 40px;">직위</span>
						 <input type="text" name="sign_pos" id="sign_pos" size="30" style="height : 40px; " value="${member.employee_pos}" readonly="readonly">						 
					</div>
						<div class="input-group" style="border: 1px solid rgb(238, 238, 238); width: 90%;  margin: 0px auto 10px auto;">
						 <span class="input-group-text" style="width: 100px; font-weight: bold; height : 40px;">첨부파일</span>
						 <input type="file" id="upload" name="upload" size="30" style="height : 40px; "> 					 
					</div>
					<div class="input-group" id="group" style="border: 1px solid rgb(238, 238, 238); width: 90%; margin: 0px auto 10px auto;">   
	                  <span class="input-group-text" style="width: 100px; font-weight: bold; height : 40px;" >수신자1</span>
	                   <input type="text" name="sign_nreceiver1" id="sign_nreceiver1" maxlength="10"  readonly="readonly" style="height : 40px; ">
                    ...
                    <div class="input-group" id="group" style="border: 1px solid rgb(238, 238, 238); width: 90%; margin: 0px auto 10px auto;">   
	                  <span class="input-group-text" style="width: 100px; font-weight: bold; height : 40px;" >수신자2</span>
	                   <input type="text" name="sign_nreceiver2" id="sign_nreceiver2" maxlength="10"  readonly="readonly" style="height : 40px; " >
                    ...
                    <div class="input-group" id="group" style="border: 1px solid rgb(238, 238, 238); width: 90%; margin: 0px auto 10px auto;">   
	                  <span class="input-group-text" style="width: 100px; font-weight: bold; height : 40px;" >수신자3</span>
	                   <input type="text" name="sign_nreceiver3" id="sign_nreceiver3" maxlength="10" value='' readonly="readonly" style="height : 40px; ">
                    ...
                    <div class="input-group" id="group" style="border: 1px solid rgb(238, 238, 238); width: 90%; margin: 0px auto 10px auto;">   
	                  <span class="input-group-text" style="width: 100px; font-weight: bold; height : 40px;">수신자4</span>
	                   <input type="text" name="sign_nreceiver4" id="sign_nreceiver4" maxlength="10"  readonly="readonly"style="height : 40px; ">
