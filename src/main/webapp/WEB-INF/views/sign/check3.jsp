...
function searchname(num, name) {
	opener.document.getElementById('sign_receiver3').value = num;
	opener.document.getElementById('sign_nreceiver3').value = name;
	this.close();
}
</script>
</head>
...
<form action="check3" method="post" onSubmit="return formCheck();">
